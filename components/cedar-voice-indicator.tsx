...
interface CedarVoiceIndicatorProps {
  voiceState: {
    isListening: boolean
    isSpeaking: boolean
...
export const CedarVoiceIndicator: React.FC<CedarVoiceIndicatorProps> = ({
  voiceState,
}) => {
      ...
      >
        ...
        {isSpeaking && (
          <>
            ...
            <span className="text-sm font-medium text-gray-900">Speaking...</span>
            <motion.div
              className="w-4 h-4"
              animate={{
                scale: [1, 1.2, 1],
